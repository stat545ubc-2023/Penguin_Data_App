  ...
  # Feature 3. I added radio button selection based on year, this is helpful as it allows the user to view data collected in a specified year.
                ...
                mainPanel(
                  tabsetPanel(
                    ...
                    tabPanel("Histogram", h3("Bill Depth Histogram"), p("The histogram graph below is compatible with the pengiun species dropdown menu, located at the top of the right panel. Select a pengiun species and observe diffenece in the frequency of different bill depths. This Histogram is also compatible with year choice radio buttons, if you would like to see how the pengiuns bill depths changed over years sampled (how Darwininan!)"), plotOutput("histogram")),
